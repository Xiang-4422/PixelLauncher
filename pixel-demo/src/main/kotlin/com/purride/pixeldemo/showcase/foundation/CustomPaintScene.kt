        ...
        return Column(
            ...
            children = listOf(
                ...
                CustomPaint(width = 42, height = 28) {
                    ...
                    drawRect(0, 0, 42, 28, PixelColor.White)
                    drawLine(2, 24, 39, 3, PixelColor.fromRgb(255, 192, 64))
                    drawCircle(11, 9, 5, PixelColor.fromRgb(80, 180, 110), filled = false)
                    drawPolygon(
                    ...
                    drawPath(
                        path = PixelPath(
                            commands = listOf(
                                PixelPathCommand.MoveTo(PixelPoint(5, 22)),
                                PixelPathCommand.LineTo(PixelPoint(12, 16)),
                                PixelPathCommand.LineTo(PixelPoint(19, 22)),
                            ),
                        ),
