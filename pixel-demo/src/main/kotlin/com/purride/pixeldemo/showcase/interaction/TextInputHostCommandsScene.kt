...
object TextInputHostCommandsScene : DemoScene {
    ...
    override val description = "updateFocusedTextInput / clearFocusedTextInput / submitFocusedTextInput"
...
private class TextInputHostCommandsWidget(
    ...
    inner class TextInputHostCommandsState : State<TextInputHostCommandsWidget>() {
        ...
        override fun build(context: BuildContext): Widget = Padding(
            child = Column(
                children = listOf(
                    Text("聚焦此 TextField 后点击下方按钮", style = TextStyle.Default, softWrap = true),
                    SizedBox(height = 4),
                    TextField(
                        state = fieldState,
