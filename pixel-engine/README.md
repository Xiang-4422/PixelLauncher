...
| 文档 | 适合你想…… |
|---|---|
| [快速入门](docs/使用说明/快速入门.md) | 跟着教程把 SDK 接入到一个真实 Activity，覆盖按钮 / 文字 / 列表 / 主题 |
| [组件目录](docs/使用说明/组件目录.md) | 查 SDK 全部内置 widget 目录与签名 |
| [主题系统](docs/使用说明/主题系统.md) | 学怎么用 token + 主题做全局换肤 / 单点覆盖 |
...
| [动画方向](docs/演进规划/动画方向.md) | 了解像素动画的取向与未来路线（设计文档，非已有功能）|
| [动画实现计划](docs/演进规划/动画实现计划.md) | 动画系统 Layer 1+2 的可执行实现计划（交接文档）|
| [色彩演进](docs/演进规划/色彩演进.md) | 了解未来彩色模式 / 单色模式并存的设计方向（设计文档，非已有功能）|
| [彩色实现计划](docs/演进规划/彩色实现计划.md) | 彩色系统 Phase A-E 的可执行实现计划（交接文档，前置依赖动画完成）|
