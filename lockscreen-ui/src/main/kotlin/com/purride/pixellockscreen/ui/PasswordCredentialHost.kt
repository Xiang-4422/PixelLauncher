...
public class PasswordCredentialHost(
    ...
    /** 当前点大小和宿主尺寸解析出的逻辑布局。 */
    private var currentLayout: PasswordCredentialLayout = passwordCredentialLayout()
    ...
    /** 根据当前物理尺寸重算密码页几何，并原子更新场景与透明语义节点。 */
    private fun updateLogicalLayout(widthPx: Int, heightPx: Int, submitScene: Boolean) {
        ...
        /** 新物理尺寸对应的密码页布局。 */
        val nextLayout = passwordCredentialLayout(logicalSize.first, logicalSize.second)
